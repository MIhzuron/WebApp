            ...
            <ul class="nav user-menu pull-right">
                ...
                <li class="nav-item dropdown has-arrow">
					...
					<div class="dropdown-menu">
						...
						<a class="dropdown-item" href="edit-profile.html">ערוך פרופיל</a>
        ...
        <div class="page-wrapper">
            <div class="content container-fluid">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="card-box">
                        <h3 class="card-title">מידע בסיסי</h3>
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group form-focus">
                                                <label class="focus-label">שם פרטי</label>
                                                <input type="text" class="form-control floating">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group form-focus">
                                                <label class="focus-label">שם משפחה</label>
                                                <input type="text" class="form-control floating">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group form-focus">
                                                <label class="focus-label">תאריך לידה</label>
                                                <div class="cal-icon">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group form-focus select-focus">
                                                <label class="focus-label">מין</label>
